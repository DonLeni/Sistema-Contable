...
return [
    ...
    */
    ...
    'logo_img' => 'vendor/adminlte/dist/img/Lg.png',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'url' => 'admin/settings',
            'icon' => 'fas fa-fw fa-sharp fa-light fa-inbox',
            'submenu' => [
                [
        ...
        [
            'text' => 'Seguridad',
            'url' => 'admin/settings',
            'icon' => 'fas fa-fw fa-sharp fa-light fa-address-card',
            'submenu' => [
                [
                    'text' => 'Gestion de usuario',
                    'icon' => 'fas fa-fw fa-sharp fa-light fa-street-view',
                    'icon_color' => 'teal',
                    'url' => '#',
                ],
                
                [
                    'text' => 'Configuracion de sistema',
                    'icon' => 'fas fa-fw fa-sharp fa-light fa-street-view',
                    'icon_color' => 'teal',
                    'url' => '#',
                ],
